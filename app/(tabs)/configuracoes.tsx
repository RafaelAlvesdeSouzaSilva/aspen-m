...
export default function Configuracoes() {
  ...
  function confirmarExclusao() {
    Alert.alert(
      ...
      [
        ...
        { text: "Excluir", style: "destructive", onPress: () => Alert.alert("Em breve", "Funcionalidade em desenvolvimento.") },
      ]
    );
  }
  ...
  return (
    <ScrollView style={styles.container}>
      <Header titulo="Configurações" subtitulo="Gerencie as preferências da sua conta." />
      ...
      <View style={styles.body}>
        ...
        <View style={styles.menu}>
          {menuItens.map((item) => (
            ...
            >
              <Text style={[styles.menuItemText, abaAtiva === item && styles.menuItemTextAtivo]}>{item}</Text>
            </TouchableOpacity>
          ))}
        </View>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.configRow}>
                <View style={styles.configInfo}>
                  ...
                  <Text style={styles.configDesc}>{usuario?.email ?? "—"}</Text>
                </View>
              </View>
              <View style={styles.divider} />
              <View style={styles.configRow}>
                <View style={styles.configInfo}>
                  ...
                  <Text style={styles.configDesc}>{usuario?.name ?? "—"}</Text>
                </View>
              </View>
              <View style={styles.divider} />
              <View style={styles.configRow}>
          ...
          {abaAtiva === "Privacidade" && (
            <View style={styles.card}>
              ...
              <View style={styles.configRow}>
                ...
                <Switch value={compartilharDados} onValueChange={setCompartilharDados} trackColor={{ false: "#e2e8f0", true: TEAL }} thumbColor="white" />
              </View>
              <View style={styles.divider} />
              <View style={styles.configRow}>
                <View style={styles.configInfo}>
                ...
                <Switch value={cookies} onValueChange={setCookies} trackColor={{ false: "#e2e8f0", true: TEAL }} thumbColor="white" />
              </View>
            </View>
          )}
          ...
          {abaAtiva === "Segurança" && (
            <View style={styles.card}>
              ...
              <View style={styles.configRow}>
                ...
                <Switch value={doisFatores} onValueChange={setDoisFatores} trackColor={{ false: "#e2e8f0", true: TEAL }} thumbColor="white" />
              </View>
              <View style={styles.divider} />
              <View style={styles.configRow}>
                <View style={styles.configInfo}>
                ...
                <Switch value={alertasLogin} onValueChange={setAlertasLogin} trackColor={{ false: "#e2e8f0", true: TEAL }} thumbColor="white" />
              </View>
            </View>
          )}
          ...
          {abaAtiva === "Preferências" && (
            <View style={styles.card}>
              ...
              <View style={styles.configRow}>
                ...
                <Switch value={notifEmail} onValueChange={setNotifEmail} trackColor={{ false: "#e2e8f0", true: TEAL }} thumbColor="white" />
              </View>
            </View>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  menu: { width: 110, backgroundColor: "white", borderRadius: 12, borderWidth: 0.5, borderColor: "#e2e8f0", overflow: "hidden" },
  ...
  conteudo: { flex: 1 },
  card: { backgroundColor: "white", borderRadius: 12, borderWidth: 0.5, borderColor: "#e2e8f0", padding: 16 },
  cardTitulo: { fontSize: 15, fontWeight: "700", color: "#0f172a", marginBottom: 12 },
  configRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: 14, gap: 8 },
  configInfo: { flex: 1 },
  ...
  selectWrap: { flexDirection: "row", alignItems: "center", gap: 4, borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6 },
