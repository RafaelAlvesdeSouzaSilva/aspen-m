...
export default function Perfil() {
  ...
  const [nome, setNome] = useState("Rafael Alves de Souza Silva");
  const [email, setEmail] = useState("rafinhaalvesss70@gmail.com");
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.avatarSection}>
        ...
        <Text style={styles.avatarNome}>Rafael Alves de Souza Silva</Text>
        <Text style={styles.avatarEmail}>rafinhaalvesss70@gmail.com</Text>
        <View style={styles.planoBadge}>
          <Text style={styles.planoBadgeText}>Plano Básico</Text>
        </View>
      </View>
      ...
      >
        {abas.map((aba) => (
          ...
          >
            <Text
              style={[styles.abaText, abaAtiva === aba && styles.abaTextAtiva]}
            >
              {aba}
            </Text>
          </TouchableOpacity>
        ...
        {abaAtiva === "Segurança" && (
          <View style={styles.card}>
            <View style={styles.infoRow}>
              <View>
                <Text style={styles.infoTitulo}>Senha atual</Text>
                <Text style={styles.infoDesc}>Última alteração há 30 dias</Text>
              </View>
              <TouchableOpacity>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.btnAtivo}>
                <Text style={styles.btnAtivoText}>Ativado</Text>
              </View>
            </View>
            <View style={styles.divider} />
            <View style={styles.infoRow}>
              <View>
                <Text style={styles.infoTitulo}>Sessões ativas</Text>
                <Text style={styles.infoDesc}>
                  3 sessões em dispositivos diferentes
                </Text>
              </View>
              <TouchableOpacity>
                <Text style={[styles.linkAlterar, { color: "#ef4444" }]}>
                  Encerrar todas
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.card}>
            <View style={styles.infoRow}>
              <View>
                ...
                <Text style={styles.infoDesc}>Básico — Gratuito</Text>
              </View>
              <View style={styles.btnAtivo}>
            ...
            <View style={styles.infoRow}>
              <View>
                ...
                <Text style={styles.infoDesc}>Plano gratuito não renova</Text>
              </View>
            </View>
            <View style={styles.divider} />
...
const styles = StyleSheet.create({
  ...
  linkAlterar: { fontSize: 13, color: TEAL, fontWeight: "600" },
  btnAtivo: {
