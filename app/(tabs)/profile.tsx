...
export default function Perfil() {
  ...
  useEffect(() => {
    async function carregar() {
      try {
        ...
        setTelefone(u.phone ?? "");
        setCpf(u.document ?? "");
        setPlan(u.plan ?? "basico");
        setPlanExpiresAt(u.plan_expires_at ?? null);
      } catch (err) {
  ...
  async function salvar() {
    try {
      await api.put("/auth/profile", { name: nome, email, phone: telefone || null, document: cpf || null });
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.avatarSection}>
        ...
        <Text style={styles.avatarNome}>{nome || "Carregando..."}</Text>
        <Text style={styles.avatarEmail}>{email}</Text>
        <View style={styles.planoBadge}>
          <Text style={styles.planoBadgeText}>Plano {planLabel(plan)}</Text>
        </View>
      </View>
          ...
          <View style={styles.card}>
            <View style={styles.infoRow}>
              <View>
                ...
                <Text style={styles.infoDesc}>{planLabel(plan)}{plan === "basico" ? " — Gratuito" : ""}</Text>
              </View>
              <View style={styles.btnAtivo}>
